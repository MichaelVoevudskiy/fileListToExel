...
def create_xlsx_file(file_path: str, headers: dict, items: list):
    ...
    # Записываем имена файлов в следующие строки
...
# Укажите путь к папке, для которой нужно создать список файлов
print(Fore.WHITE, '''
    Вкажіть шлях до директорії: ''' ,Fore.YELLOW,"(приклад:  D:\doc\main  )" )
print(Fore.WHITE)
folder_path = input()
